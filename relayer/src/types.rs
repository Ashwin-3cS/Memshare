...
pub struct Config {
    ...
    /// Embedding model name (default: openai/text-embedding-3-small)
    pub embedding_model: String,
    /// Optional embedding dimensions override (e.g. 1024 for Jina)
    pub embedding_dimensions: Option<u32>,
    /// LLM model name for fact extraction and /api/ask (default: openai/gpt-4o-mini)
...
pub struct RecallRequest {
    ...
    pub namespace: String,
    #[serde(default)]
    pub filters: MemoryQueryFilters,
}
...
pub struct MemoryMetadata {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recipient_scope: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct RememberBatchRequest {
    pub facts: Vec<RememberRequest>,
}

#[derive(Debug, Serialize)]
pub struct RememberBatchResponse {
    pub facts: Vec<RememberResponse>,
    pub total: usize,
    pub owner: String,
}
