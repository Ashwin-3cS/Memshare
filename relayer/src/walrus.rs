...
pub struct OnChainBlob {
    ...
    #[serde(rename = "capsuleId", default)]
...
struct WalrusUploadRequest {
    ...
    #[serde(rename = "capsuleId", skip_serializing_if = "Option::is_none")]
...
pub async fn upload_blob(
    ...
    let resp = client
        ...
        .json(&WalrusUploadRequest {
            ...
            capsule_id: capsule_id.map(|s| s.to_string()),
...
pub async fn query_blobs_by_owner(
    ...
    if let Some(capsule_id) = capsule_id {
        body["capsuleId"] = serde_json::json!(capsule_id);
    }
